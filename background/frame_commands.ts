...
export const showAiBar = (): void => {
  ...
  const options = BgUtils_.safer_<CmdOptions[kFgCmd.aiBar]>({
    k: BgUtils_.getOmniSecret_(true),
    h: vomnibarBgOptions_.maxBoxHeight_,
  })
  portSendFgCmd(port, kFgCmd.aiBar, true, options, cRepeat)
  set_cOptions(options as never)
}
