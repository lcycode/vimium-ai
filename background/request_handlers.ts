...
import { handleAiQuery, handleAiCancel } from "./ai"
...
set_reqH_([
  ...
  /** kFgReq.aiQuery: */ (req: FgReq[kFgReq.aiQuery], port: Port): void => {
    handleAiQuery(req, port)
  },
  /** kFgReq.aiCancel: */ (req: FgReq[kFgReq.aiCancel]): void => {
    handleAiCancel(req.i)
  }
])
