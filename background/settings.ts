...
js\\:|Js: javascript:\\ $S; JavaScript`,
    ...
    waitForEnter: true,
    aiApiKey: "",
    aiApiProvider: "deepseek",
    aiApiEndpoint: "https://api.deepseek.com/v1/chat/completions",
    aiModel: "deepseek-chat",
    aiMaxTokens: 4096,
    aiSystemPrompt: "You are Vimium C's AI assistant, embedded in the browser. " +
        "The user will give you the text content of the current webpage plus a question. " +
        "Answer concisely in the user's language. Cite specific parts of the page when relevant. " +
        "If the page content is insufficient to answer, say so directly."
}
