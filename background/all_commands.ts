...
import {
  parentFrame, showVomnibar, showAiBar, findContentPort_, marksActivate_, enterVisualMode, toggleZoom, captureTab, getBlurOption_,
...
//#endregion
  ...
  /* kBgCmd.showAiBar: */ _AsBgC<BgCmdNoTab<kBgCmd.showAiBar>>(showAiBar)
])
