...
declare namespace SettingsNS {
  ...
  interface BaseBackendSettings {
    ...
    /** DeepSeek API key */ aiApiKey: string
    /** AI provider: only "deepseek" for now */ aiApiProvider: string
    /** AI API endpoint (base URL) */ aiApiEndpoint: string
    /** AI model name */ aiModel: string
...
declare const enum kHandler {
  __none, __normal, __insert, __next, linkHints, marks, find, visual, omni, aiBar,
  NOT_MEAN_kModeId,
