...
declare const enum kBgReq {
  ...
  COMMON_AI_MIN = 50,
  ai_chunk = COMMON_AI_MIN, ai_done, ai_error, ai_ack,
...
declare const enum kFgReq {
  ...
  afterTee, _deleted1, syncStatus, focusCurTab, aiQuery, aiCancel, END,
...
interface BgAIBarSpecialReq {
  ...
  [kBgReq.ai_ack]: {
    /** id */ i: number;
    /** normalized request URL */ u: string;
    /** whether an API key is set */ k: boolean;
    /** model name */ m: string;
  };
}
interface FullBgReq extends BgReq, BgVomnibarSpecialReq, BgAIBarSpecialReq {}
...
interface FgReq {
  ...
  [kFgReq.focusCurTab]: {}
  [kFgReq.aiQuery]: AIBarNS.QueryRequest
  [kFgReq.aiCancel]: {
...
declare namespace Req {
  ...
  type bg<K extends kBgReq> =
    ...
    K extends keyof BgAIBarSpecialReq ? BgAIBarSpecialReq[K] & baseBg<K> :
    never;
