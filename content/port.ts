...
let requestHandlers: {
  [k in keyof BgReq]: (this: void, request: BgReq[k]) => unknown
} & Partial<{
  [k in kBgReq.ai_chunk | kBgReq.ai_done | kBgReq.ai_error | kBgReq.ai_ack]: (this: void, request: BgAIBarSpecialReq[k]) => unknown
}>
